package com.transport.simulator.models;
...
/**
 * A callable (so we can invoke in on a executor and join on it) that sends
 * messages to a queue periodically - representing the journey of a delivery
 * vehicle.
 */
