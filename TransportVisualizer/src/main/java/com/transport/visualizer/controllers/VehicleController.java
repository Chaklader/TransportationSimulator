package com.transport.visualizer.controllers;
...
import com.transport.visualizer.services.PositionTrackingExternalService;
...
//        Vehicle vehicle = data.findById(id).get();
//        data.delete(vehicle);
